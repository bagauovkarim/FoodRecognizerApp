#!/usr/bin/env python3
"""
Оценка best_model_81percent на случайной выборке
...
print("=" * 80)
print("🔬 ОЦЕНКА BEST MODEL 81% НА СЛУЧАЙНОЙ ВЫБОРКЕ")
print("=" * 80)
print()
...
with open('best_model_random_sample_results.txt', 'w', encoding='utf-8') as f:
    f.write("BEST MODEL 81% RANDOM SAMPLE EVALUATION\n")
    f.write("=" * 80 + "\n\n")
...
print("💾 Результаты сохранены в: best_model_random_sample_results.txt")
print()
print("=" * 80)
